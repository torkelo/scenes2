...
import type { Options as TimeSeriesOptions } from '@grafana/schema/dist/esm/raw/composable/timeseries/panelcfg/x/TimeSeriesPanelCfg_types.gen';
import type { Options as TrendOptions } from '@grafana/schema/dist/esm/raw/composable/trend/panelcfg/x/TrendPanelCfg_types.gen';
import {
...
export const PanelOptionsBuilders = {
  barchart() {
    return new PanelOptionsBuilder<BarChartOptions>(
      () => defaultBarChartOptions,
    );
  },
  bargauge() {
    return new PanelOptionsBuilder<BarGaugeOptions>(
      () => defaultBarGaugeOptions,
    );
  },
  flamegraph() {
    return new PanelOptionsBuilder<object>();
  },
  gauge() {
  ...
  histogram() {
    return new PanelOptionsBuilder<HistogramOptions>(
  ...
  piechart() {
    return new PanelOptionsBuilder<PieChartOptions>(
  ...
  statetimeline() {
    return new PanelOptionsBuilder<StateTimelineOptions>(
      () => defaultStateTimelineOptions,
    );
  },
  statushistory() {
    return new PanelOptionsBuilder<StatusHistoryOptions>(
