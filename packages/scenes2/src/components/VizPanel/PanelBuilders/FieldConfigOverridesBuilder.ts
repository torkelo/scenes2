...
export class FieldConfigOverridesBuilder<
  TFieldConfig,
> extends StandardFieldConfigOverridesBuilder<
...
> {
  ...
  public overrideCustomFieldConfig<T extends TFieldConfig, K extends keyof T>(
    id: K,
    value: T[K],
  ): this {
