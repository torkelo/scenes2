...
import type { FieldConfigOverridesBuilder } from './FieldConfigOverridesBuilder';
import { PanelOptionsBuilder } from './PanelOptionsBuilder';
import type { DeepPartial } from './types';
import type {
  StandardFieldConfig,
  StandardFieldConfigInterface,
  VizConfig,
} from './types';

export class VizConfigBuilder<
  TOptions extends object,
  TFieldConfig extends object,
> implements StandardFieldConfigInterface<
  StandardFieldConfig,
  VizConfigBuilder<TOptions, TFieldConfig>,
  'set'
> {
  ...
  public setCustomFieldConfig<T extends TFieldConfig, K extends keyof T>(
    id: K,
  ...
  public setOverrides(
    builder: (b: FieldConfigOverridesBuilder<TFieldConfig>) => void,
  ): this {
   ...
   */
  public setOption<T extends TOptions, K extends keyof T>(
    id: K,
    value: DeepPartial<T[K]>,
  ): this {
