...
<!--
  Vendored from https://github.com/yzhao062/agent-style
  (commit e3f14369e66095e518f7b5b328a6cfdc9eb97163, v0.3.6 line), then
  prettier-formatted to satisfy this repo's format check. Content is unchanged.
  Based on "The Elements of Agent Style" (https://github.com/yzhao062/agent-style), CC BY 4.0.

  Do not edit this file by hand — refresh it from upstream instead. Repo-specific
  overrides (RULE-G headings, RULE-I contractions) live in the written-style rule
  (.hatch/_rules/written-style.md) and docs/WRITTEN_STYLE_GUIDE.md, not here.
-->
...
> _"Break any of these rules sooner than say anything outright barbarous."_
...
- **source**: Orwell 1946, "Politics and the English Language," Rule 3: _"Never use the passive where you can use the active."_ Strunk & White §II.14 "Use the active voice."
- **agent-instruction evidence**: Zhang et al. 2026 supports negative phrasing for anti-pattern directives in coding-agent instruction files (does not validate mechanical enforcement). Bohr 2025 supports pairing directives with examples for stronger initial style control over a paired two-turn code-generation workflow (not open-ended prose).
...
- **source**: Strunk & White §II.16: _"Use definite, specific, concrete language."_ Pinker 2014 Ch. 3 frames abstraction as a primary vector of the curse of knowledge (writer has the specifics; reader does not, and cannot resolve abstract pointers like "factors" or "aspects").
- **agent-instruction evidence**: Zhang et al. 2026 supports negative phrasing for anti-pattern directives in coding-agent instruction files (does not validate mechanical enforcement). Bohr 2025 supports pairing directives with examples for stronger initial style control over a paired two-turn code-generation workflow (not open-ended prose).
...
- **source**: Strunk & White §II.17: _"Omit needless words. Vigorous writing is concise."_ Orwell 1946 Rule 3: _"If it is possible to cut a word out, always cut it out."_
...
- **source**: Orwell 1946, "Politics and the English Language," Rule 1: _"Never use a metaphor, simile, or other figure of speech which you are used to seeing in print."_
...
- **source**: Strunk & White §II.15: _"Put statements in positive form."_
...
- **source**: Strunk & White §II.19: _"Express coordinate ideas in similar form."_
...
- **source**: Strunk & White §II.20: _"Keep related words together."_ Gopen & Swan 1990 treat verb-subject proximity as a structural readability concern in scientific prose specifically (long subject-to-verb gaps are one of the most common causes of unreadable science writing).
